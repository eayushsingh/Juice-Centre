        ...
        <main className="pt-24 min-h-screen bg-[#FFFDF8]">
            ...
            <div className="max-w-7xl mx-auto px-[5%] pb-20">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="bg-white p-8 md:p-12 rounded-[40px] shadow-xl shadow-orange-100/50 border border-orange-100">
                        ...
                        <div className="space-y-10">
                            <div>
                                ...
                                <div className="space-y-6 ml-9">
                                    <div>
                                        <p className="text-xs font-bold text-slate-400 uppercase tracking-widest mb-1">MG Road, Secunderabad</p>
                                        <a href="tel:+918639271639" className="text-xl text-orange-500 font-bold hover:underline">+91 86392 71639</a>
                                    </div>
                                    <div>
                                        <p className="text-xs font-bold text-slate-400 uppercase tracking-widest mb-1">Tolichowki, Hyderabad</p>
                                        <a href="tel:+919346036222" className="text-xl text-orange-500 font-bold hover:underline">+91 93460 36222</a>
                                    </div>
                                    <div>
                                        <p className="text-xs font-bold text-slate-400 uppercase tracking-widest mb-1">Bandlaguda, Hyderabad</p>
                                        <a href="tel:+919398588286" className="text-xl text-orange-500 font-bold hover:underline">+91 93985 88286</a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="bg-orange-500 p-8 md:p-12 rounded-[40px] text-white overflow-hidden relative shadow-2xl shadow-orange-200">
                        <div className="relative z-10">
                            ...
                            <a
                                href="/branches"
                                className="inline-flex items-center gap-2 bg-white text-orange-500 font-bold px-8 py-4 rounded-2xl hover:bg-orange-50 transition-all shadow-lg"
                            >
                                📍 View All Locations
                            </a>
                        </div>
