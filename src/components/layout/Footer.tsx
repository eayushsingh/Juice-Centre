...
export default function Footer() {
    return (
        <footer className="bg-slate-950 text-white py-[60px] md:py-[100px] px-[5%] border-t border-white/5 font-body">
            <div className="max-w-7xl mx-auto">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 mb-16 md:mb-20">
                    ...
                    <div className="space-y-6 md:space-y-8">
                        ...
                        <div className="flex items-center gap-4">
                            {['fb', 'ig', 'tw'].map(s => (
                                <div key={s} className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center hover:bg-orange-500 hover:border-orange-500 cursor-pointer transition-all active:scale-90 shadow-lg">
                    ...
                    <div>
                        ...
                        <ul className="space-y-3 md:space-y-4">
                            {links.map(l => (
                                <li key={l.href}>
                                    <Link href={l.href} className="text-slate-400 hover:text-orange-500 transition-colors text-sm md:text-base font-bold block group py-1">
                    ...
                    <div>
                        ...
                        <div className="space-y-6 md:space-y-8">
                            <div className="group">
                                <p className="text-orange-500 font-bold text-[10px] md:text-xs uppercase tracking-widest mb-2">Secunderabad</p>
                                <a href="tel:+918639271639" className="text-slate-200 font-bold text-sm md:text-base block hover:text-orange-500 transition-colors min-h-[44px] flex items-center">
                                    +91 86392 71639
                                </a>
                            </div>
                            <div className="group">
                                <p className="text-green-500 font-bold text-[10px] md:text-xs uppercase tracking-widest mb-2">Bandlaguda</p>
                                <a href="tel:+919533133316" className="text-slate-200 font-bold text-sm md:text-base block hover:text-orange-500 transition-colors min-h-[44px] flex items-center">
                                    +91 95331 33316
                                </a>
                            </div>
                        </div>
                    ...
                    <div>
                        ...
                        <div className="p-6 bg-white/5 rounded-[30px] border border-white/10 space-y-4 backdrop-blur-sm">
                            <div className="flex justify-between items-center pb-3 border-b border-white/10">
                                <span className="text-slate-400 text-[10px] md:text-xs font-bold font-body">MON–SUN</span>
                                <span className="text-green-500 font-bold text-[10px] md:text-xs font-body">OPEN</span>
                            </div>
                            <p className="text-white font-bold text-lg md:text-xl font-display">9:00 AM – 11:30 PM</p>
                            <p className="text-slate-500 text-[9px] md:text-[10px] font-bold uppercase tracking-wider">Seasonally adjusted hours</p>
                        </div>
                    </div>
                ...
                <div className="pt-8 md:pt-10 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-6 text-center md:text-left">
                    <p className="text-slate-500 text-[10px] md:text-xs font-bold flex items-center gap-2">
